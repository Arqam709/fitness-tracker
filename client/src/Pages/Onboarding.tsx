...
const Onboarding = () => {
  ...
  const handleNext = async () => {
    if (step === 1) {
      if (!formData.age || Number(formData.age) < 13 || Number(formData.age) > 120) {
        toast.error("Age is required (13-120)");
        return;
      }
    }
  ...
  goal: formData.goal,
  dailyCaloriesIntake: formData.dailyCalorieIntake,
  dailyCaloriesBurn: formData.dailyCalorieBurn,
};
  ...
  return (
    <>
      ...
      <div className="onboarding-container">
        ...
        {/* Main content area */}
        <div className="flex-1 px-6 onboarding-wrapper flex flex-col">
          {/* Step 1 */}
          {step === 1 && (
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    This help us to calculate your needs
                  </p>
                </div>
              </div>
              <Input
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    we will tailor your experience
                  </p>
                </div>
              </div>
